...
_LOADER_STUBS: dict[str, tuple[str, object]] = {
    ...
    "load_context_dsv4_kind_module_data": (f"{_OPS_PKG}.dsv4", None),
    "load_generation_dsv4_kind_module_data": (f"{_OPS_PKG}.dsv4", None),
    "load_dsv4_sparse_kernel_data": (f"{_OPS_PKG}.dsv4", None),
