...
_MOE_MODEL_CONFIGS: list[list] = [
    ...
    [3072, 1536, 8, 256, "nvidia/MiniMax-M2.5-NVFP4"],
    [3072, 1536, 8, 256, "MiniMaxAI/MiniMax-M2.7"],
    [3072, 1536, 8, 256, "nvidia/MiniMax-M2.7-NVFP4"],
...
def _dsv4_module_tp_sizes(model_path: str) -> list[int]:
    """Return TP sizes supported by the model's DSV4 attention layout."""
    return list(_DSV4_PRO_MODULE_TP_SIZES if "Pro" in model_path else _DSV4_MODULE_TP_SIZES)
