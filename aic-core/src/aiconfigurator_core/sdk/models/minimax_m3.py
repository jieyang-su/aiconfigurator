    ...
    def __init__(self, topk: int, num_experts: int, moe_inter_size: int, *args) -> None:
        ...
        self.context_ops.extend(
            [
                ...
                ops.ElementWise("context_dense_act_gate", dense_layers, 2 * dense_inter // tp_size, dense_inter // tp_size, 0.8),
        ...
        self.generation_ops.extend(
            [
                ...
                ops.GEMM("generation_dense_qkv_gemm", dense_layers * mtp, local_heads * self._head_size + 2 * local_kv_heads * self._head_size, h, gemm_quant_mode),
                ops.GenerationAttention("generation_dense_attention", dense_layers * mtp, local_heads, local_kv_heads, kvcache_quant_mode, head_size=self._head_size, use_qk_norm=True),
                ops.GEMM("generation_dense_proj_gemm", dense_layers * mtp, h, local_heads * self._head_size, gemm_quant_mode),
                ...
                ops.GEMM("generation_dense_gate_up_gemm", dense_layers * mtp, 2 * dense_inter // tp_size, h, gemm_quant_mode),
                ops.ElementWise("generation_dense_act_gate", dense_layers * mtp, 2 * dense_inter // tp_size, dense_inter // tp_size, 0.8),
