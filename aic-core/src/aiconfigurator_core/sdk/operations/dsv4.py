...
# Granular DSV4 helpers are fully represented by Rust ops.  These shells keep
# the Python import surface used by model builders without adding a second
# query implementation.
class DeepSeekV4KVAllGather(_core.DeepSeekV4KVAllGather, OpShellKit):
    pass


class DeepSeekV4SparseAttention(_core.DeepSeekV4SparseAttention, OpShellKit):
    pass
