...
# SGLang's DeepSeek KV projection has the same Rust GEMM payload.  Keep the
# model-facing name as a type aliasing shell; execution remains the GEMM Rust
# variant and therefore follows the single performance oracle.
